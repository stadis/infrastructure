...
# /usr/bin/rsync -azrdu --delete -e 'ssh -p23' u364842@u364842.your-storagebox.de:backups/ms/www/WWW-SQL-Dump.sql /tmp/sql-dump.sql
/usr/bin/rsync -azrdu --delete -e 'ssh -p23' $DestSSHInfo:$DestFolder_WWW/WWW-SQL-Dump.sql /tmp/sql-dump.sql
...
## Home Folder
# /usr/bin/rsync -azrdu --delete -e 'ssh -p23' u364842@u364842.your-storagebox.de:backups/ms/root-home/ /root/
/usr/bin/rsync -azrdu --delete -e 'ssh -p23' $DestSSHInfo:$DestFolder_RootHomeFolder/ /root/
## Docker Stuff
...
/usr/bin/rsync -azrdu --delete -e 'ssh -p23' $DestSSHInfo:$DestFolder_Docker/ /dockerData/
